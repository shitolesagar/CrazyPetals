...
namespace CrazyPetals.Service.Utility
{
    public static class StringConstants
    {
        ...
        public static readonly string SubCatDeleted = "Subcategory Deleted Successfully";
        ...
        public static readonly string Subcategory = "Subcategory not belongs to the given category.";
        ...
        public static readonly string SubCatAdded = "Subcategory Added Successfully";
        public static readonly string SubCatNotFound = "SubCategory not found.";
        ...
        public static readonly string SubCatUpdated = "Subcategory Updated Successfully";
